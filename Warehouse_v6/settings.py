"""
Django settings for Warehouse_v6 project.
...
SECRET_KEY = 'django-insecure-5m%i1qh$@yhba^x8)y5u()=fuz*9+jkr97g_a%eo=qzh0vimkk'
...
ROOT_URLCONF = 'Warehouse_v6.urls'
...
WSGI_APPLICATION = 'Warehouse_v6.wsgi.application'
